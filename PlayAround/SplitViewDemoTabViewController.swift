...
class SplitViewDemoTabViewController: UIViewController {
  ...
  private func createHeaderView() -> UIView {
    ...
    subtitleLabel.text =
      "A powerful wrapper that allows UISplitViewController to be pushed onto navigation stacks"
  ...
  private func createFeaturesView() -> UIView {
    ...
    let features = [
      (
        "sidebar.left", "Navigation Stack Integration",
        "Push split views onto navigation stacks like any other view controller"
      ),
      (
        "ipad.and.iphone", "Adaptive Layout",
